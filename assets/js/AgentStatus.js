...
const logMessages = [
    ...
    { agent: 0, msg: "Mounting Regional Shards (Africa, Europe, Asia, Americas)..." },
    { agent: 1, msg: "Geospatial Aggregation: Merging coordinate streams..." },
    { agent: 2, msg: "Validating ICAO/IATA integrity across shards..." },
    { agent: 0, msg: "Legacy Monoliths Detected: PURGING airports.csv..." },
    { agent: 0, msg: "Legacy Monoliths Detected: PURGING south_africa.csv..." },
    { agent: 0, msg: "Legacy Monoliths Detected: PURGING americas.csv..." },
