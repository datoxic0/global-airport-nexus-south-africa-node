            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <div className="flex items-center gap-4 mt-2">
                        ...
                        <span className=${`px-2 py-0.5 text-xs rounded-md border font-mono flex items-center gap-1 transition-colors duration-500 ${
                            syncStatus === 'SYNCED' ? 'bg-emerald-900/30 text-emerald-400 border-emerald-500/30' : 
                            syncStatus === 'SEEDING' || syncStatus === 'LOADING' ? 'bg-blue-900/30 text-blue-400 border-blue-500/30 animate-pulse' :
